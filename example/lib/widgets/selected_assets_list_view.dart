...
class SelectedAssetsListView extends StatelessWidget {
  ...
  final void Function(List<AssetEntity>? result, String imageKey) onResult;
  final void Function(int index, String imageKey) onRemoveAsset;
  ...
  Widget _selectedAssetDeleteButton(BuildContext context, int index, String imageKey) {
    return GestureDetector(
      onTap: () => onRemoveAsset(index, imageKey),
      child: DecoratedBox(
  ...
  Widget selectedAssetsListView(BuildContext context, String imageKey) {
    return Expanded(
                ...
                children: <Widget>[
                  ...
                  ValueListenableBuilder<bool>(
                    ...
                    builder: (_, bool value, __) => AnimatedPositioned(
                      ...
                      child: _selectedAssetDeleteButton(context, index, imageKey),
                    ),
                  ),
                ],
              ),
      ...
      builder: (_, bool value, __) => AnimatedContainer(
        ...
        child: Column(
          children: <Widget>[
            ...
            selectedAssetsListView(context, imageKey),
          ],
        ),
      ),
    );
